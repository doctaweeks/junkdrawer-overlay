...
inherit eutils multilib pam ssl-cert systemd autotools

DESCRIPTION="The Erlang Jabber Daemon"
HOMEPAGE="http://www.ejabberd.im/ https://github.com/processone/ejabberd/"
SRC_URI="https://github.com/processone/ejabberd/archive/${PV}.tar.gz -> ${P}.tar.gz"
...
src_prepare() {
	epatch "${FILESDIR}"/${PN}-15.10-ejabberdctl.patch
